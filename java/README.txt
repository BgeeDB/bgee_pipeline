...
The default configuration of java.util.logging will be overridden using jdkLogConfig.properties. If you do not want this behavior to take place, use the system property java.util.logging.config.file to point to a different configuration file.
