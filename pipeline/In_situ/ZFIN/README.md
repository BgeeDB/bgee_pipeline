...
* The expressions.expressionFound (present/absent) information is only available from ZFIN. The absence of expression is not represented in Alliance yet. Only the presence of expression in standard/control conditions and wild-type/standard fish is represented in Alliance/AllianceMine.
* The probe ratings (quality) information is only available from ZFIN.
