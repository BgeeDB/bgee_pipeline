...
(25, 7955,  'single-cell RNA-Seq', 'annotation'),
(25, 9031,  'single-cell RNA-Seq', 'annotation'),
(25, 9258,  'single-cell RNA-Seq', 'annotation'),
(25, 9483,  'single-cell RNA-Seq', 'annotation'),
(25, 9541,  'single-cell RNA-Seq', 'annotation'),
(25, 9544,  'single-cell RNA-Seq', 'annotation'),
(25, 9545,  'single-cell RNA-Seq', 'annotation'),
(25, 9593,  'single-cell RNA-Seq', 'annotation'),
(25, 9598,  'single-cell RNA-Seq', 'annotation'),
(25, 9606,  'single-cell RNA-Seq', 'annotation'),
(25, 9823,  'single-cell RNA-Seq', 'annotation'),
(25, 9986,  'single-cell RNA-Seq', 'annotation'),
(25, 10090, 'single-cell RNA-Seq', 'annotation'),
(25, 10116, 'single-cell RNA-Seq', 'annotation'),
(25, 10181, 'single-cell RNA-Seq', 'annotation'),
(25, 13616, 'single-cell RNA-Seq', 'annotation');

-- source of data for single cell data
INSERT INTO dataSourceToSpecies (dataSourceId, speciesId, dataType, infoType) VALUES
(102, 7227,  'single-cell RNA-Seq', 'data'),
(102, 7955,  'single-cell RNA-Seq', 'data'),
(102, 9031,  'single-cell RNA-Seq', 'data'),
(102, 9258,  'single-cell RNA-Seq', 'data'),
(102, 9483,  'single-cell RNA-Seq', 'data'),
(102, 9541,  'single-cell RNA-Seq', 'data'),
(102, 9544,  'single-cell RNA-Seq', 'data'),
(102, 9545,  'single-cell RNA-Seq', 'data'),
(102, 9593,  'single-cell RNA-Seq', 'data'),
(102, 9598,  'single-cell RNA-Seq', 'data'),
(102, 9606,  'single-cell RNA-Seq', 'data'),
(102, 9823,  'single-cell RNA-Seq', 'data'),
(102, 9986,  'single-cell RNA-Seq', 'data'),
(102, 10090, 'single-cell RNA-Seq', 'data'),
(102, 10116, 'single-cell RNA-Seq', 'data'),
(102, 10181, 'single-cell RNA-Seq', 'data'),
(102, 13616, 'single-cell RNA-Seq', 'data');
