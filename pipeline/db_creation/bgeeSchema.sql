...
-- ** NUMBER OF OBSERVATIONS PER DATA TYPE **
    estSelfObservationCount MEDIUMINT UNSIGNED NOT NULL DEFAULT 0,
    estDescendantObservationCount MEDIUMINT UNSIGNED NOT NULL DEFAULT 0,

    affymetrixSelfObservationCount MEDIUMINT UNSIGNED NOT NULL DEFAULT 0,
    affymetrixDescendantObservationCount MEDIUMINT UNSIGNED NOT NULL DEFAULT 0,

    inSituSelfObservationCount MEDIUMINT UNSIGNED NOT NULL DEFAULT 0,
    inSituDescendantObservationCount MEDIUMINT UNSIGNED NOT NULL DEFAULT 0,

    rnaSeqSelfObservationCount MEDIUMINT UNSIGNED NOT NULL DEFAULT 0,
    rnaSeqDescendantObservationCount MEDIUMINT UNSIGNED NOT NULL DEFAULT 0,

    scRnaSeqFullLengthSelfObservationCount MEDIUMINT UNSIGNED NOT NULL DEFAULT 0,
    scRnaSeqFullLengthDescendantObservationCount MEDIUMINT UNSIGNED NOT NULL DEFAULT 0,
