...
-- so this simplifies its enum.
    ...
    estSexPropagationState ENUM('self', 'descendant', 'self and descendant') COMMENT 'The origin of the propagated EST data related to the sex of the related condition. If null, it means that sex were not considered in this propagated call, or that the call is not supported by any EST data.',
    estStrainPropagationState ENUM('self', 'descendant', 'self and descendant') COMMENT 'The origin of the propagated EST data related to the strain of the related condition. If null, it means that strain were not considered in this propagated call, or that the call is not supported by any EST data.',
    ...
    affymetrixSexPropagationState ENUM('all', 'self', 'ancestor', 'descendant', 'self and ancestor',
    'self and descendant', 'ancestor and descendant') COMMENT 'The origin of the propagated Affymetrix data related to the sex of the related condition. If null, it means that sexes were not considered in this propagated call, or that the call is not supported by any Affymetrix data.',
    affymetrixStrainPropagationState ENUM('all', 'self', 'ancestor', 'descendant', 'self and ancestor',
    'self and descendant', 'ancestor and descendant') COMMENT 'The origin of the propagated Affymetrix data related to the strain of the related condition. If null, it means that stages were not considered in this propagated call, or that the call is not supported by any Affymetrix data.',
    ...
    inSituSexPropagationState ENUM('all', 'self', 'ancestor', 'descendant', 'self and ancestor',
    'self and descendant', 'ancestor and descendant') COMMENT 'The origin of the propagated in situ hybridization data related to the sex of the related condition. If null, it means that sexes were not considered in this propagated call, or that the call is not supported by any in situ hybridization data.',
    inSituStrainPropagationState ENUM('all', 'self', 'ancestor', 'descendant', 'self and ancestor',
    'self and descendant', 'ancestor and descendant') COMMENT 'The origin of the propagated in situ hybridization data related to the strain of the related condition. If null, it means that strains were not considered in this propagated call, or that the call is not supported by any in situ hybridization data.',
    ...
    'self and descendant', 'ancestor and descendant') COMMENT 'The origin of the propagated single cell full length RNA-Seq data related to the developmental stage of the related condition. If null, it means that developmental stages were not considered in this propagated call, or that the call is not supported by any single cell full length RNA-Seq data.',
    scRnaSeqFullLengthSexPropagationState ENUM('all', 'self', 'ancestor', 'descendant', 'self and ancestor',
...
-- ** PVALUES PER DATATYPE **
    ...
    pValueAffymetrix decimal(31, 30) unsigned default null,
    pValueEst decimal(31, 30) unsigned default null,
    pValueInSitu decimal(31, 30) unsigned default null,
    pValueRnaSeq decimal(31, 30) unsigned default null,
    pValueScRnaSeqFullLength decimal(31, 30) unsigned default null,
    pValueAffymetrixEst decimal(31, 30) unsigned default null,
    pValueAffymetrixInSitu decimal(31, 30) unsigned default null,
    pValueAffymetrixRnaSeq decimal(31, 30) unsigned default null,
    pValueAffymetrixScRnaSeqFullLength decimal(31, 30) unsigned default null,
    pValueEstInSitu decimal(31, 30) unsigned default null,
    pValueEstRnaSeq decimal(31, 30) unsigned default null,
    pValueEstScRnaSeqFullLength decimal(31, 30) unsigned default null,
    pValueInSituRnaSeq decimal(31, 30) unsigned default null,
    pValueInSituScRnaSeqFullLength decimal(31, 30) unsigned default null,
    pValueRnaSeqScRnaSeqFullLength decimal(31, 30) unsigned default null,
    pValueAffymetrixEstInSitu decimal(31, 30) unsigned default null,
    pValueAffymetrixEstRnaSeq decimal(31, 30) unsigned default null,
    pValueAffymetrixEstScRnaSeqFullLength decimal(31, 30) unsigned default null,
    pValueAffymetrixInSituRnaSeq decimal(31, 30) unsigned default null,
    pValueAffymetrixInSituScRnaSeqFullLength decimal(31, 30) unsigned default null,
    pValueAffymetrixRnaSeqScRnaSeqFullLength decimal(31, 30) unsigned default null,
    pValueEstInSituRnaSeq decimal(31, 30) unsigned default null,
    pValueEstInSituScRnaSeqFullLength decimal(31, 30) unsigned default null,
    pValueEstRnaSeqScRnaSeqFullLength decimal(31, 30) unsigned default null,
    pValueInSituRnaSeqScRnaSeqFullLength decimal(31, 30) unsigned default null,
    pValueAffymetrixEstInSituRnaSeq decimal(31, 30) unsigned default null,
    pValueAffymetrixEstInSituScRnaSeqFullLength decimal(31, 30) unsigned default null,
    pValueAffymetrixEstRnaSeqScRnaSeqFullLength decimal(31, 30) unsigned default null,
    pValueAffymetrixInSituRnaSeqScRnaSeqFullLength decimal(31, 30) unsigned default null,
    pValueEstInSituRnaSeqScRnaSeqFullLength decimal(31, 30) unsigned default null,
    pValueAffymetrixEstInSituRnaSeqScRnaSeqFullLength decimal(31, 30) unsigned default null,

-- ** PVALUES PER DATATYPE BEST DESCENDANT **

    pValueBestDescendantAffymetrix decimal(31, 30) unsigned default null,
    pValueBestDescendantEst decimal(31, 30) unsigned default null,
    pValueBestDescendantInSitu decimal(31, 30) unsigned default null,
    pValueBestDescendantRnaSeq decimal(31, 30) unsigned default null,
    pValueBestDescendantScRnaSeqFullLength decimal(31, 30) unsigned default null,
    pValueBestDescendantAffymetrixEst decimal(31, 30) unsigned default null,
    pValueBestDescendantAffymetrixInSitu decimal(31, 30) unsigned default null,
    pValueBestDescendantAffymetrixRnaSeq decimal(31, 30) unsigned default null,
    pValueBestDescendantAffymetrixScRnaSeqFullLength decimal(31, 30) unsigned default null,
    pValueBestDescendantEstInSitu decimal(31, 30) unsigned default null,
    pValueBestDescendantEstRnaSeq decimal(31, 30) unsigned default null,
    pValueBestDescendantEstScRnaSeqFullLength decimal(31, 30) unsigned default null,
    pValueBestDescendantInSituRnaSeq decimal(31, 30) unsigned default null,
    pValueBestDescendantInSituScRnaSeqFullLength decimal(31, 30) unsigned default null,
    pValueBestDescendantRnaSeqScRnaSeqFullLength decimal(31, 30) unsigned default null,
    pValueBestDescendantAffymetrixEstInSitu decimal(31, 30) unsigned default null,
    pValueBestDescendantAffymetrixEstRnaSeq decimal(31, 30) unsigned default null,
    pValueBestDescendantAffymetrixEstScRnaSeqFullLength decimal(31, 30) unsigned default null,
    pValueBestDescendantAffymetrixInSituRnaSeq decimal(31, 30) unsigned default null,
    pValueBestDescendantAffymetrixInSituScRnaSeqFullLength decimal(31, 30) unsigned default null,
    pValueBestDescendantAffymetrixRnaSeqScRnaSeqFullLength decimal(31, 30) unsigned default null,
    pValueBestDescendantEstInSituRnaSeq decimal(31, 30) unsigned default null,
    pValueBestDescendantEstInSituScRnaSeqFullLength decimal(31, 30) unsigned default null,
    pValueBestDescendantEstRnaSeqScRnaSeqFullLength decimal(31, 30) unsigned default null,
    pValueBestDescendantInSituRnaSeqScRnaSeqFullLength decimal(31, 30) unsigned default null,
    pValueBestDescendantAffymetrixEstInSituRnaSeq decimal(31, 30) unsigned default null,
    pValueBestDescendantAffymetrixEstInSituScRnaSeqFullLength decimal(31, 30) unsigned default null,
    pValueBestDescendantAffymetrixEstRnaSeqScRnaSeqFullLength decimal(31, 30) unsigned default null,
    pValueBestDescendantAffymetrixInSituRnaSeqScRnaSeqFullLength decimal(31, 30) unsigned default null,
    pValueBestDescendantEstInSituRnaSeqScRnaSeqFullLength decimal(31, 30) unsigned default null,
    pValueBestDescendantAffymetrixEstInSituRnaSeqScRnaSeqFullLength decimal(31, 30) unsigned default null,
