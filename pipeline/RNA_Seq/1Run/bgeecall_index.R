...
slurm_options_index <- list(account = account, time = time, partition = partition, mem = "130G")
# generate indexes
generate_slurm_indexes(userFile=bgeecall_input_file, rscript_path = paste0(container_cmd, " Rscript"), slurm_options = slurm_options_index, kallistoMetadata = kallistoMetadata, bgeeMetadata=bgeeMetadata, userMetadata = userMetadata, nodes=100)
