...
#$InsertedDataSources{'zfin_id_trans_name'}       = $InsertedDataSources{'zfin'}; #NOTE we don't want them, they cannot be cross-linked
...
#$InsertedDataSources{'hgnc_trans_name'}          = $InsertedDataSources{'hgnc'}; #NOTE we don't want them, they cannot be cross-linked
...
#$InsertedDataSources{'mirbase_trans_name'}       = $InsertedDataSources{'mirbase'}; #NOTE we don't want them, they cannot be cross-linked
